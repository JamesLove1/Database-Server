...
public class QuiryTokeniser {
  String query;
  String[] specialCharacters = {"(", ")", ",", ";"};
  ArrayList<String> tokens = new ArrayList<>();

  public static void main(String[] args) {
    String quiryStatic = "INSERT INTO people VALUES('Simon Lock', 35, 'simon@bristol.ac.uk', 1.8);";
    new QuiryTokeniser(quiryStatic).setup();
    System.out.println(new QuiryTokeniser(quiryStatic).getTokens());
  }

  public QuiryTokeniser(){
    this.query = "";
    this.setup();
  }

  public QuiryTokeniser(String command){
